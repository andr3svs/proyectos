# Data Provenance - P12 Thermodynamics

## Metadata
- **Experiment**: P12 - Thermal Waves in a Metal Bar
- **Source**: `Termodinamica\p12_termodinamica\p12.py` and `p12.xlsx`
- **Timestamp**: 2026-04-27

## Parameters & Constants
| Quantity | Symbol | Value | Uncertainty | Unit | Source |
|----------|--------|-------|-------------|------|--------|
| Specific Heat Capacity (Al) | $c_p$ | 900 | | J/(kg·K) | p12.py |
| Density (Al) | $\rho$ | 2700 | | kg/m³ | p12.py |
| Radius of Cylinder | $R$ | 0.010 | | m | p12.py |
| Distance between Sensors | $d$ | 0.050 | 0.0010 | m | p12.py |
...
## Fit Results (ODR)
### Sensor 1 ($\theta_1$)
- **Mean Temperature ($A_{\theta_1}$)**: $53.11 \pm 0.018$ °C
- **Amplitude ($Amp_{\theta_1}$)**: $1.40 \pm 0.025$ °C
- **Period ($\tau_{\theta_1}$)**: $475.76 \pm 1.26$ s
- **Phase Shift ($\phi_{\theta_1}$)**: $0.20 \pm 0.037$ rad

### Sensor 2 ($\theta_2$)
- **Mean Temperature ($A_{\theta_2}$)**: $60.47 \pm 0.031$ °C
- **Amplitude ($Amp_{\theta_2}$)**: $-3.98 \pm 0.044$ °C
- **Period ($\tau_{\theta_2}$)**: $474.81 \pm 0.72$ s
- **Phase Shift ($\phi_{\theta_2}$)**: $2.49 \pm 0.021$ rad

## Derived Parameters
- **Parameter $m$**: $20.91 \pm 0.60$ m⁻¹
- **Parameter $h$**: $45.71 \pm 1.25$ m⁻¹
- **Thermal Diffusivity ($K_{exp}$)**: $16.75 \pm 0.81$ SI Units
- **Thermal Conductivity ($\lambda_{exp}$)**: $138.40 \pm 5.84$ W/(m·K)
