...
\end{table}
% Datos: ejecute el script `p5.py` en la carpeta `p5_termodinamica` y exporte las tablas
% generadas (la librería `uncertainties.ufloat` se utiliza para obtener los
% valores en formato ``x \pm u_x''). Pegue aquí las tablas resultantes para
% completar los apartados anteriores.
