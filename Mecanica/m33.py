...
plt.plot(C_distancias_m[C_number_maxima.astype(int)], np.array(C_voltaje)[C_number_maxima.astype(int)], 'rv', markersize=8, label='Máximos detectados')
plt.plot(C_distancias_m[C_number_minima.astype(int)], np.array(C_voltaje)[C_number_minima.astype(int)], 'b^', markersize=8, label='Mínimos detectados')
